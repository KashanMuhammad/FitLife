...
class _MealsHistoryScreenState extends State<MealsHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final dateBeforeYesterday = DateTime.now().subtract(
    ...
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final beforeYesterday = DateTime.now().subtract(
            const Duration(days: 2),
          );
          ...
          // Build subtitle text
          String consumptionText = filteredConsumptions
              .map((c) {
          ...
          return CustomListTile(
            ...
            trailing: IconButton(
              onPressed: () {
                if (userData != null &&
                    userData!.assignedFoods != null &&
                    userData!.assignedFoods!.isNotEmpty) {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder:
                          (context) => AssignedFoodDetailScreen(
