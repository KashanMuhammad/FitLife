...
class HealthIssuesInputScreen extends StatefulWidget {
  @override
  State<HealthIssuesInputScreen> createState() =>
      _HealtIssuesInputScreenState();
}
  ...
  Widget buildNextButton() {
    return InkWell(
      onTap: () async {
        ...
        if (userId != null) {
          String selectedHealthIssues = options[selectedIndex];
          try {
            ...
            await FirebaseFirestore.instance
                .collection(
                  'Users',
                ) // Make sure this matches your other screens
                .doc(userId.uid)
