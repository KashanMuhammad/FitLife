...
import '../custom widgets/add_meals_tile.dart';
import '../custom widgets/summary_meals_tile.dart';
  ...
  Future<void> _addFood(FoodModel food) async {
    ...
    try {
      ...
      if (snapshot.exists && snapshot.data()!.containsKey("userSelectedFood")) {
        updatedFoods =
            (snapshot["userSelectedFood"] as List<dynamic>)
                ...
                child: Padding(
                  ...
                  child: ListView(
                    children: [
                      ...
                      if (selectedFoodsByMeal[selectedMealType]!
                          .isNotEmpty) ...[
                        Text(
                          selectedMealType,
                          style: const TextStyle(
                        ...
                        GridView.builder(
                          ...
                          itemCount:
                              selectedFoodsByMeal[selectedMealType]!.where((
                                food,
                              ) {
                                final entryDate =
                                    DateTime.tryParse(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final qty =
                                int.tryParse(
                                  food.consumptions.first.foodQuantity,
                                ) ??
                                1;
