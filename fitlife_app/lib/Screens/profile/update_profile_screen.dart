    ...
    final updatedUser = FirebaseDataModelClass(
      ...
      dateOfBirth:
          dateofbirthController.text.trim().isNotEmpty
              ...
              : null,
      weight:
          weightParts.isNotEmpty ? double.tryParse(weightParts.first) : null,
      weightUnit:
          weightParts.length > 1 ? weightParts.last : userModel?.weightUnit,
      height:
          heightParts.isNotEmpty ? double.tryParse(heightParts.first) : null,
      heightUnit:
          heightParts.length > 1 ? heightParts.last : userModel?.heightUnit,
    );
