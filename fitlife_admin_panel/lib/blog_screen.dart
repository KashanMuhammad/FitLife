...
class _BlogScreenState extends State<BlogScreen> {
  ...
  // Store selected blogId + blog details separately
  final ValueNotifier<String?> selectedBlogId = ValueNotifier<String?>(null);
  final ValueNotifier<Map<String, dynamic>?> selectedBlog =
                ...
                builder: (context, snapshot) {
                  ...
                  return Row(
                    ...
                    children: [
                      ...
                      // Right: Blog Details (only rebuilds itself)
                      Expanded(
                        flex: 1,
                        child: ValueListenableBuilder<Map<String, dynamic>?>(
                          valueListenable: selectedBlog,
                          builder: (context, blog, _) {
                            if (blog == null) {
                              return const Center(
                                child: Text("Select a blog to view details"),
                              );
                            }
                            return _buildBlogDetails(blog);
                          },
                        ),
                      ),
                    ],
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ValueListenableBuilder<String?>(
          valueListenable: selectedBlogId,
          builder: (context, selectedId, _) {
            final isSelected = selectedId == blogId;
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              blog['blogShortDescription'] ?? "No short description available",
